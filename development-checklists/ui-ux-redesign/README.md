...
- [x] Hero секція редизайнена з floating tyre image
...
## Джерело вимог
- `plan/result_audit/ui-ux-audit-bridgestone-home-2026.md` — повний аудит та рекомендації
- `plan/result_audit/ui-ux-redesign-tasks-bridgestone-home-2026.md` — план впровадження
