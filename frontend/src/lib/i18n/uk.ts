...
export const uk = {
  common: {
    home: "Головна",
    search: "Пошук",
    findDealer: "Знайти магазин поруч",
  ...
  home: {
    whyBridgestone: "Чому нам довіряють мільйони водіїв",
    whyBridgestoneDescription: "Поєднання інновацій, безпеки та довіри мільйонів водіїв по всьому світу.",
    tyresBySeason: "Готові до будь-якої погоди",
    tyresBySeasonDescription: "Оберіть шини, які відповідають вашому стилю водіння та умовам на дорозі.",
    popularModels: "Найкращий вибір українських водіїв",
    popularModelsDescription: "Перевірені моделі Bridgestone для комфортних та безпечних поїздок.",
    adviceTitle: "Корисні поради для водіїв",
    adviceDescription: "Як правильно обирати, використовувати та доглядати за шинами.",
    readArticle: "Читати →",
    goTo: "Обрати шини",
    loadingPopularModels: "Завантаження популярних моделей...",
    needHelpChoosing: "Не впевнені, які шини обрати?",
    needHelpDescription: "Наші експерти допоможуть підібрати ідеальні шини саме для вас.",
  },
  hero: {
    summerSeason: "Готуйтесь до літа",
    winterSeason: "Зробіть зиму безпечною",
    officialSite: "Офіційний сайт Bridgestone в Україні",
    defaultTitle: "Безпека на кожному кілометрі",
    defaultSubtitle: "Шини Bridgestone — офіційний представник в Україні",
    readyForSummer: "Готові до літніх подорожей",
    readyForWinter: "Впевненість у будь-яку погоду",
    readyForAny: "Шини для вашого стилю життя",
    ...
    anyWeatherDescription: "Оберіть шини, які підходять саме вам.",
    searchBySize: "Підбір за розміром або маркою авто",
    catalogDescription: "Літні, зимові та всесезонні шини",
    dealersMap: "Мережа офіційних дилерів по всій Україні",
    tyreAdvice: "Експертні поради щодо вибору шин",
  },
  features: {
    safetyFirst: "Безпека на першому місці",
    safetyDescription: "Технології, що забезпечують надійне зчеплення в будь-яких умовах.",
    fuelSaving: "Економія палива",
    fuelDescription: "Знижений опір коченню для зменшення витрат на пального.",
    expertSupport: "Експертна підтримка",
    expertDescription: "Консультації від офіційних дилерів та сервісних центрів.",
    globalQuality: "Глобальна якість",
    qualityDescription: "Продукція, що відповідає міжнародним стандартам безпеки.",
  },
  tyreCategories: {
    summerName: "Літні шини",
    summerDescription: "Для теплої пори року, оптимальні для сухого та мокрого асфальту.",
    winterName: "Зимові шини",
    winterDescription: "Максимальне зчеплення на снігу та льоду в зимових умовах.",
    allseasonName: "Всесезонні шини",
    allseasonDescription: "Компромісне рішення для помірного клімату без екстремальних умов.",
  },
  advice: {
  ...
  cta: {
    needHelp: "Не впевнені, які шини обрати?",
    getConsultation: "Допоможіть мені обрати",
    findDealer: "Знайти магазин поруч",
