        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-8">
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="animate-pulse">
              ...
              <div className="h-4 w-4/5 rounded bg-stone-200 dark:bg-white/10 mb-8" />
              <div className="space-y-3">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="flex items-start gap-3">
                    <div className="h-8 w-8 rounded-full bg-stone-200 dark:bg-white/10" />
                    <div className="flex-1">
                      <div className="h-4 w-1/3 rounded bg-stone-200 dark:bg-white/10 mb-2" />
                      <div className="h-3 w-2/3 rounded bg-stone-200 dark:bg-white/10" />
                    </div>
                  </div>
                ))}
              </div>
