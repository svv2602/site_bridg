...
import { Car, Shield, Zap, Sun, Snowflake, Cloud, Filter, ChevronRight, Star } from "lucide-react";
...
export default function PassengerTyresPage() {
  const passengerTyres = MOCK_TYRE_MODELS.filter((m) =>
          ...
          >
            <div className="text-zinc-50">
              <nav className="mb-2 text-xs text-zinc-400">
                ...
                <span className="font-medium text-zinc-100">Шини для легкових авто</span>
              </nav>
      ...
      <section className="py-12 bg-gradient-to-b from-card to-background">
        <div className="container mx-auto max-w-7xl px-4 md:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {passengerTyres.slice(0, 6).map((model, idx) => (
              <motion.div
                key={model.slug}
