...
import { AlertTriangle, RefreshCw, Home, Cpu } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-lg px-4 text-center">
        <div className="rounded-2xl border border-red-200 dark:border-red-900 bg-red-50 dark:bg-red-950/30 p-10">
          <div className="relative mx-auto mb-6 h-16 w-16">
            <Cpu className="h-16 w-16 text-red-300" />
            <AlertTriangle className="absolute -bottom-1 -right-1 h-8 w-8 text-red-500" />
          </div>
          <h2 className="text-2xl font-bold text-red-800 dark:text-red-200 mb-2">
            Помилка завантаження
          </h2>
          <p className="text-red-600 dark:text-red-300 mb-6">
            Не вдалося завантажити інформацію про технології. Спробуйте оновити сторінку.
          </p>
          {error.message && (
