...
9. НЕ використовуй звертання до читача — ніяких "братан", "друзі", "хлопці", "панове". Відгук — це розповідь від першої особи про свій досвід, а не звернення до аудиторії.
10. Уникай зворотних присвійних займенників "свій/своя/своє/свої/своїй/свого" — замість "на своїй Honda CR-V" пиши "на Honda CR-V", замість "свого авто" — "мого авто" або просто "авто".
...
"${diversity.propertyAccent}"`
  ...
  const bannedList = [
    ...
    "братан", "друзі", "хлопці", "панове", "ну що",
    "свій", "своя", "своє", "свої", "своїй", "свого", "своїм", "своїх",
  ];
...
8. НЕ використовуй звертання до читача — ніяких "братан", "друзі", "хлопці", "панове", "ну що". Відгук — це розповідь від першої особи про досвід, а не звернення до аудиторії.
9. Уникай зворотних присвійних займенників "свій/своя/своє/свої/своїй/свого" — замість "на своїй Honda CR-V" пиши "на Honda CR-V", замість "свого авто" — "мого авто" або просто "авто".
